...
class MessageActionWidget {
  static Future<void> _saveImageToGallery(BuildContext context, String message) async {
    try {
      ...
      // Create friendsGo directory if it doesn't exist
      final directory = Directory('/storage/emulated/0/Pictures/friendsGo');
      ...
      final fileName = 'friendsgo_$timestamp$extension';
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Image saved to Gallery/friendsGo')),
        );
      } else {
